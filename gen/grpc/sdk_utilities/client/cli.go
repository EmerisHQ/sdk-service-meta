...
// BuildIbcChannelClientStatePayload builds the payload for the sdk-utilities
// ibcChannelClientState endpoint from CLI flags.
func BuildIbcChannelClientStatePayload(sdkUtilitiesIbcChannelClientStateMessage string) (*sdkutilities.IbcChannelClientStatePayload, error) {
	var err error
	var message sdk_utilitiespb.IbcChannelClientStateRequest
	{
		if sdkUtilitiesIbcChannelClientStateMessage != "" {
			err = json.Unmarshal([]byte(sdkUtilitiesIbcChannelClientStateMessage), &message)
			if err != nil {

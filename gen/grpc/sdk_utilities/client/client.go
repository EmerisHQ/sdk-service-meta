...
// EmoneyInflation calls the "EmoneyInflation" function in
// sdk_utilitiespb.SdkUtilitiesClient interface.
func (c *Client) EmoneyInflation() goa.Endpoint {
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		inv := goagrpc.NewInvoker(
			BuildEmoneyInflationFunc(c.grpccli, c.opts...),
			EncodeEmoneyInflationRequest,
			DecodeEmoneyInflationResponse)
		res, err := inv.Invoke(ctx, v)
		if err != nil {
			return nil, goa.Fault(err.Error())
		}
...
// BudgetParams calls the "BudgetParams" function in
// sdk_utilitiespb.SdkUtilitiesClient interface.
func (c *Client) BudgetParams() goa.Endpoint {
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		inv := goagrpc.NewInvoker(
			BuildBudgetParamsFunc(c.grpccli, c.opts...),
			EncodeBudgetParamsRequest,
			DecodeBudgetParamsResponse)
		res, err := inv.Invoke(ctx, v)
		if err != nil {
			return nil, goa.Fault(err.Error())
		}
...
// DistributionParams calls the "DistributionParams" function in
// sdk_utilitiespb.SdkUtilitiesClient interface.
func (c *Client) DistributionParams() goa.Endpoint {
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		inv := goagrpc.NewInvoker(
			BuildDistributionParamsFunc(c.grpccli, c.opts...),
			EncodeDistributionParamsRequest,
			DecodeDistributionParamsResponse)
		res, err := inv.Invoke(ctx, v)
		if err != nil {
			return nil, goa.Fault(err.Error())
		}
...
// OsmoPools calls the "OsmoPools" function in
// sdk_utilitiespb.SdkUtilitiesClient interface.
func (c *Client) OsmoPools() goa.Endpoint {
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		inv := goagrpc.NewInvoker(
			BuildOsmoPoolsFunc(c.grpccli, c.opts...),
			EncodeOsmoPoolsRequest,
			DecodeOsmoPoolsResponse)
		res, err := inv.Invoke(ctx, v)
		if err != nil {
			return nil, goa.Fault(err.Error())
		}
...
// CrescentPools calls the "CrescentPools" function in
// sdk_utilitiespb.SdkUtilitiesClient interface.
func (c *Client) CrescentPools() goa.Endpoint {
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		inv := goagrpc.NewInvoker(
			BuildCrescentPoolsFunc(c.grpccli, c.opts...),
			EncodeCrescentPoolsRequest,
			DecodeCrescentPoolsResponse)
		res, err := inv.Invoke(ctx, v)
		if err != nil {
			return nil, goa.Fault(err.Error())
		}

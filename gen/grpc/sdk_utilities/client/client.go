...
// IbcChannelClientState calls the "IbcChannelClientState" function in
// sdk_utilitiespb.SdkUtilitiesClient interface.
func (c *Client) IbcChannelClientState() goa.Endpoint {
	return func(ctx context.Context, v interface{}) (interface{}, error) {
		inv := goagrpc.NewInvoker(
			BuildIbcChannelClientStateFunc(c.grpccli, c.opts...),
			EncodeIbcChannelClientStateRequest,
			DecodeIbcChannelClientStateResponse)
		res, err := inv.Invoke(ctx, v)
		if err != nil {
			return nil, goa.Fault(err.Error())
		}

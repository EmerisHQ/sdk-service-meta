...
// BuildIbcChannelClientStateFunc builds the remote method to invoke for
// "sdk-utilities" service "ibcChannelClientState" endpoint.
func BuildIbcChannelClientStateFunc(grpccli sdk_utilitiespb.SdkUtilitiesClient, cliopts ...grpc.CallOption) goagrpc.RemoteFunc {
	return func(ctx context.Context, reqpb interface{}, opts ...grpc.CallOption) (interface{}, error) {
		for _, opt := range cliopts {
			opts = append(opts, opt)
		}
		if reqpb != nil {
			return grpccli.IbcChannelClientState(ctx, reqpb.(*sdk_utilitiespb.IbcChannelClientStateRequest), opts...)
		}
		return grpccli.IbcChannelClientState(ctx, &sdk_utilitiespb.IbcChannelClientStateRequest{}, opts...)
	}
}

// EncodeIbcChannelClientStateRequest encodes requests sent to sdk-utilities
// ibcChannelClientState endpoint.
func EncodeIbcChannelClientStateRequest(ctx context.Context, v interface{}, md *metadata.MD) (interface{}, error) {
	payload, ok := v.(*sdkutilities.IbcChannelClientStatePayload)
	if !ok {
		return nil, goagrpc.ErrInvalidType("sdk-utilities", "ibcChannelClientState", "*sdkutilities.IbcChannelClientStatePayload", v)
	}
	return NewProtoIbcChannelClientStateRequest(payload), nil
}

// DecodeIbcChannelClientStateResponse decodes responses from the sdk-utilities
// ibcChannelClientState endpoint.
func DecodeIbcChannelClientStateResponse(ctx context.Context, v interface{}, hdr, trlr metadata.MD) (interface{}, error) {
	message, ok := v.(*sdk_utilitiespb.IbcChannelClientStateResponse)
	if !ok {
		return nil, goagrpc.ErrInvalidType("sdk-utilities", "ibcChannelClientState", "*sdk_utilitiespb.IbcChannelClientStateResponse", v)
	}
	res := NewIbcChannelClientStateResult(message)
	return res, nil
}

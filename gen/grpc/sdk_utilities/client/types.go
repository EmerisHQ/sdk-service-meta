...
// NewStakingPoolRequest builds the gRPC request type from the payload of the
// "stakingPool" endpoint of the "sdk-utilities" service.
func NewStakingPoolRequest(payload *sdkutilities.StakingPoolPayload) *sdk_utilitiespb.StakingPoolRequest {
...
// NewEmoneyInflationRequest builds the gRPC request type from the payload of
// the "emoneyInflation" endpoint of the "sdk-utilities" service.
func NewEmoneyInflationRequest(payload *sdkutilities.EmoneyInflationPayload) *sdk_utilitiespb.EmoneyInflationRequest {

...
// NewTxFeeEstimateRequest builds the gRPC request type from the payload of the
// "txFeeEstimate" endpoint of the "sdk-utilities" service.
func NewTxFeeEstimateRequest(payload *sdkutilities.TxFeeEstimatePayload) *sdk_utilitiespb.TxFeeEstimateRequest {
...
// NewTxFeeEstimateResult builds the result type of the "txFeeEstimate"
// endpoint of the "sdk-utilities" service from the gRPC response type.
func NewTxFeeEstimateResult(message *sdk_utilitiespb.TxFeeEstimateResponse) *sdkutilities.FeeEstimate {
	result := &sdkutilities.FeeEstimate{
		Gas: message.Gas,
	}
	if message.Fees != nil {
...
// ValidateTxFeeEstimateResponse runs the validations defined on
// TxFeeEstimateResponse.
func ValidateTxFeeEstimateResponse(message *sdk_utilitiespb.TxFeeEstimateResponse) (err error) {
	if message.Fees == nil {

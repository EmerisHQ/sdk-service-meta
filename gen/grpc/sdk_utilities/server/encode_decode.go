...
// EncodeBudgetParamsResponse encodes responses from the "sdk-utilities"
...
func EncodeBudgetParamsResponse(ctx context.Context, v interface{}, hdr, trlr *metadata.MD) (interface{}, error) {
	result, ok := v.(*sdkutilities.BudgetParams2)
	if !ok {
		return nil, goagrpc.ErrInvalidType("sdk-utilities", "budgetParams", "*sdkutilities.BudgetParams2", v)
	}
	resp := NewProtoBudgetParamsResponse(result)
	return resp, nil
}

// DecodeBudgetParamsRequest decodes requests sent to "sdk-utilities" service
...
func DecodeBudgetParamsRequest(ctx context.Context, v interface{}, md metadata.MD) (interface{}, error) {
	...
	{
		if message, ok = v.(*sdk_utilitiespb.BudgetParamsRequest); !ok {
			return nil, goagrpc.ErrInvalidType("sdk-utilities", "budgetParams", "*sdk_utilitiespb.BudgetParamsRequest", v)
		}
	}
	var payload *sdkutilities.BudgetParamsPayload
	{
		payload = NewBudgetParamsPayload(message)
	}
	return payload, nil
}

// EncodeDistributionParamsResponse encodes responses from the "sdk-utilities"
// service "distributionParams" endpoint.
func EncodeDistributionParamsResponse(ctx context.Context, v interface{}, hdr, trlr *metadata.MD) (interface{}, error) {
	result, ok := v.(*sdkutilities.DistributionParams2)
	if !ok {
		return nil, goagrpc.ErrInvalidType("sdk-utilities", "distributionParams", "*sdkutilities.DistributionParams2", v)
	}
	resp := NewProtoDistributionParamsResponse(result)
	return resp, nil
}

// DecodeDistributionParamsRequest decodes requests sent to "sdk-utilities"
// service "distributionParams" endpoint.
func DecodeDistributionParamsRequest(ctx context.Context, v interface{}, md metadata.MD) (interface{}, error) {
	...
	{
		if message, ok = v.(*sdk_utilitiespb.DistributionParamsRequest); !ok {
			return nil, goagrpc.ErrInvalidType("sdk-utilities", "distributionParams", "*sdk_utilitiespb.DistributionParamsRequest", v)
		}
	}
	var payload *sdkutilities.DistributionParamsPayload
	{
		payload = NewDistributionParamsPayload(message)
	}
	return payload, nil
}

// EncodeOsmoPoolsResponse encodes responses from the "sdk-utilities" service
// "osmoPools" endpoint.
func EncodeOsmoPoolsResponse(ctx context.Context, v interface{}, hdr, trlr *metadata.MD) (interface{}, error) {
	result, ok := v.(*sdkutilities.OsmoPools2)
	if !ok {
		return nil, goagrpc.ErrInvalidType("sdk-utilities", "osmoPools", "*sdkutilities.OsmoPools2", v)
	}
	resp := NewProtoOsmoPoolsResponse(result)
	return resp, nil
}

// DecodeOsmoPoolsRequest decodes requests sent to "sdk-utilities" service
// "osmoPools" endpoint.
func DecodeOsmoPoolsRequest(ctx context.Context, v interface{}, md metadata.MD) (interface{}, error) {
	...
	{
		if message, ok = v.(*sdk_utilitiespb.OsmoPoolsRequest); !ok {
			return nil, goagrpc.ErrInvalidType("sdk-utilities", "osmoPools", "*sdk_utilitiespb.OsmoPoolsRequest", v)
		}
	}
	var payload *sdkutilities.OsmoPoolsPayload
	{
		payload = NewOsmoPoolsPayload(message)
	}
	return payload, nil
}

// EncodeCrescentPoolsResponse encodes responses from the "sdk-utilities"
// service "crescentPools" endpoint.
func EncodeCrescentPoolsResponse(ctx context.Context, v interface{}, hdr, trlr *metadata.MD) (interface{}, error) {
	result, ok := v.(*sdkutilities.CrescentPools2)
	if !ok {
		return nil, goagrpc.ErrInvalidType("sdk-utilities", "crescentPools", "*sdkutilities.CrescentPools2", v)
	}
	resp := NewProtoCrescentPoolsResponse(result)
	return resp, nil
}

// DecodeCrescentPoolsRequest decodes requests sent to "sdk-utilities" service
...
func DecodeCrescentPoolsRequest(ctx context.Context, v interface{}, md metadata.MD) (interface{}, error) {
	...
	{
		if message, ok = v.(*sdk_utilitiespb.CrescentPoolsRequest); !ok {
			return nil, goagrpc.ErrInvalidType("sdk-utilities", "crescentPools", "*sdk_utilitiespb.CrescentPoolsRequest", v)
		}
	}
	var payload *sdkutilities.CrescentPoolsPayload
	{
		payload = NewCrescentPoolsPayload(message)
	}
	return payload, nil
}

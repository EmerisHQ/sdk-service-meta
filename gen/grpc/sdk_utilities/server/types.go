...
// NewOsmoPoolsPayload builds the payload of the "osmoPools" endpoint of the
// "sdk-utilities" service from the gRPC request type.
...
// NewProtoOsmoPoolsResponse builds the gRPC response type from the result of
...
func NewProtoOsmoPoolsResponse(result *sdkutilities.OsmoPools2) *sdk_utilitiespb.OsmoPoolsResponse {
	message := &sdk_utilitiespb.OsmoPoolsResponse{
		OsmoPools: result.OsmoPools,
	}
	return message
}

...
// NewSupplyDenomResponse builds the gRPC response type from the result of the
// "supplyDenom" endpoint of the "sdk-utilities" service.
func NewSupplyDenomResponse(result *sdkutilities.Supply2) *sdk_utilitiespb.SupplyDenomResponse {
...
// NewEmoneyInflationResponse builds the gRPC response type from the result of
// the "emoneyInflation" endpoint of the "sdk-utilities" service.
func NewEmoneyInflationResponse(result *sdkutilities.EmoneyInflation2) *sdk_utilitiespb.EmoneyInflationResponse {

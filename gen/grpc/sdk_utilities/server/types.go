...
// NewTxFeeEstimatePayload builds the payload of the "txFeeEstimate" endpoint
// of the "sdk-utilities" service from the gRPC request type.
func NewTxFeeEstimatePayload(message *sdk_utilitiespb.TxFeeEstimateRequest) *sdkutilities.TxFeeEstimatePayload {
...
// NewTxFeeEstimateResponse builds the gRPC response type from the result of
// the "txFeeEstimate" endpoint of the "sdk-utilities" service.
func NewTxFeeEstimateResponse(result *sdkutilities.FeeEstimate) *sdk_utilitiespb.TxFeeEstimateResponse {
	message := &sdk_utilitiespb.TxFeeEstimateResponse{
		Gas: result.Gas,
	}
	if result.Fees != nil {
...
// ValidateTxFeeEstimateRequest runs the validations defined on
// TxFeeEstimateRequest.
func ValidateTxFeeEstimateRequest(message *sdk_utilitiespb.TxFeeEstimateRequest) (err error) {
	if message.TxBytes == nil {
		err = goa.MergeErrors(err, goa.MissingFieldError("txBytes", "message"))
	}
	return

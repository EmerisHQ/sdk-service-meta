...
type Client struct {
	...
	TxFeeEstimateEndpoint       goa.Endpoint
}

// NewClient initializes a "sdk-utilities" service client given the endpoints.
func NewClient(accountNumbers, supply, queryTx, broadcastTx, txMetadata, block, liquidityParams, liquidityPools, mintInflation, mintParams, mintAnnualProvision, delegatorRewards, txFeeEstimate goa.Endpoint) *Client {
	return &Client{
		...
		TxFeeEstimateEndpoint:       txFeeEstimate,
	}
}
...
// TxFeeEstimate calls the "txFeeEstimate" endpoint of the "sdk-utilities"
// service.
func (c *Client) TxFeeEstimate(ctx context.Context, p *TxFeeEstimatePayload) (res *FeeEstimate, err error) {
	var ires interface{}
	ires, err = c.TxFeeEstimateEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*FeeEstimate), nil
}

...
func NewClient(accountNumbers, supply, supplyDenom, queryTx, broadcastTx, txMetadata, block, liquidityParams, liquidityPools, mintInflation, mintParams, mintAnnualProvision, mintEpochProvisions, delegatorRewards, estimateFees, stakingParams, stakingPool, emoneyInflation, budgetParams, distributionParams, osmoPools, crescentPools goa.Endpoint) *Client {
	return &Client{
		...
		StakingPoolEndpoint:         stakingPool,
		EmoneyInflationEndpoint:     emoneyInflation,
		BudgetParamsEndpoint:        budgetParams,
		DistributionParamsEndpoint:  distributionParams,
		OsmoPoolsEndpoint:           osmoPools,
		CrescentPoolsEndpoint:       crescentPools,
	}
}
...
func (c *Client) StakingPool(ctx context.Context, p *StakingPoolPayload) (res *StakingPool2, err error) {
	var ires interface{}
	ires, err = c.StakingPoolEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*StakingPool2), nil
}

// EmoneyInflation calls the "emoneyInflation" endpoint of the "sdk-utilities"
// service.
func (c *Client) EmoneyInflation(ctx context.Context, p *EmoneyInflationPayload) (res *EmoneyInflation2, err error) {
	var ires interface{}
	ires, err = c.EmoneyInflationEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*EmoneyInflation2), nil
}

// BudgetParams calls the "budgetParams" endpoint of the "sdk-utilities"
// service.
func (c *Client) BudgetParams(ctx context.Context, p *BudgetParamsPayload) (res *BudgetParams2, err error) {
	var ires interface{}
	ires, err = c.BudgetParamsEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*BudgetParams2), nil
}

// DistributionParams calls the "distributionParams" endpoint of the
// "sdk-utilities" service.
func (c *Client) DistributionParams(ctx context.Context, p *DistributionParamsPayload) (res *DistributionParams2, err error) {
	var ires interface{}
	ires, err = c.DistributionParamsEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*DistributionParams2), nil
}
...
func (c *Client) OsmoPools(ctx context.Context, p *OsmoPoolsPayload) (res *OsmoPools2, err error) {
	var ires interface{}
	ires, err = c.OsmoPoolsEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*OsmoPools2), nil
}

// CrescentPools calls the "crescentPools" endpoint of the "sdk-utilities"
// service.
func (c *Client) CrescentPools(ctx context.Context, p *CrescentPoolsPayload) (res *CrescentPools2, err error) {
	var ires interface{}
	ires, err = c.CrescentPoolsEndpoint(ctx, p)
	if err != nil {
		return
	}
	return ires.(*CrescentPools2), nil
}

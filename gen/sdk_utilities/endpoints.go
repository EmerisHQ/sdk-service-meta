...
func NewEndpoints(s Service) *Endpoints {
	return &Endpoints{
		...
		OsmoPools:           NewOsmoPoolsEndpoint(s),
...
// NewOsmoPoolsEndpoint returns an endpoint function that calls the method
// "osmoPools" of service "sdk-utilities".
func NewOsmoPoolsEndpoint(s Service) goa.Endpoint {
	return func(ctx context.Context, req interface{}) (interface{}, error) {
		p := req.(*OsmoPoolsPayload)
		return s.OsmoPools(ctx, p)
	}
}

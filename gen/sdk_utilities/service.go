...
type Service interface {
	...
	TxFeeEstimate(context.Context, *TxFeeEstimatePayload) (res *FeeEstimate, err error)
}
...
// MethodKey key.
var MethodNames = [13]string{"accountNumbers", "supply", "queryTx", "broadcastTx", "txMetadata", "block", "liquidityParams", "liquidityPools", "mintInflation", "mintParams", "mintAnnualProvision", "delegatorRewards", "txFeeEstimate"}
...
// TxFeeEstimatePayload is the payload type of the sdk-utilities service
// txFeeEstimate method.
type TxFeeEstimatePayload struct {
	// Transaction bytes
	TxBytes []byte
}

// FeeEstimate is the result type of the sdk-utilities service txFeeEstimate
// method.

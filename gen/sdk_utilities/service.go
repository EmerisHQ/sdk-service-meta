...
// MethodKey key.
var MethodNames = [19]string{"accountNumbers", "supply", "supplyDenom", "queryTx", "broadcastTx", "txMetadata", "block", "liquidityParams", "liquidityPools", "mintInflation", "mintParams", "mintAnnualProvision", "mintEpochProvisions", "delegatorRewards", "estimateFees", "stakingParams", "stakingPool", "emoneyInflation", "ibcChannelClientState"}
